...
*Description:* Hoonose is struggling to transform her thoughts and feelings into words. Her frustrations bleed on paper, or, well, pixels, in a beautiful saga of self-discovery.
